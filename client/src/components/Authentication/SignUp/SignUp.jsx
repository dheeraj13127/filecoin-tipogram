...
import { Grid, Typography, Button,TextField,RadioGroup,Radio,FormControlLabel,Checkbox,FormLabel } from "@mui/material";
...
const handleSignUpSubmit=async(e)=>{
  ...
  if(user.userName===""||user.email===""||user.password===""||user.confirmPassword===""||user.gender===""||user.profileImage===""||agree===false){
        ...
        <Grid item xs={12} sm={8} md={8} lg={6} xl={4} className="signUpBox">
              ...
              <form autoComplete="off" >
                <Stack className="signUpFormBox" spacing={2}>
                  ...
                  <Button onClick={handleSignUpSubmit}  variant="contained" color="primary" className="signUpSubmitBtn">
                    Sign Up
                  </Button>
